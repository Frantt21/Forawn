...
static void my_application_activate(GApplication* application) {
  ...
  // Sin header bar nativo: la app dibuja su propia barra de título
  ...
  // Fondo por defecto: evita el parpadeo negro antes del primer frame.
  // La app pinta su propio fondo (#1E1E1E en modo oscuro) desde Flutter.
